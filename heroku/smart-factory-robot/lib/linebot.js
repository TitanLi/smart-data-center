...
module.exports = function (channelSecret, lineBotToken) {
  ...
  */
  ...
  /*
    ...
    response  {}
  */
  this.sendText = (userId, weatherImage, message, weatherMessage, specials) => {
    let options = {
      method: 'POST',
  ...
  this.sendControlText = (userId,text) => {
    let options = {
      method: 'POST',
      uri: 'https://api.line.me/v2/bot/message/push',
      headers: {
...
*/
  ...
  this.sendPower = (events, weatherImage, message, weatherMessage, specials) => {
    if (events) {
      console.log(events);
      let data = events.messageText;
      console.log(data);
