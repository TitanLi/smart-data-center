class MongoDB {
    ...
    async yesterdayAvgPowerRobot() {
        ...
        let yesterdayWaterTankPower = await this.yesterdayAvgPower('waterTankPower', yesterdayStart, yesterdayEnd);
        ...
        let yesterdayPower = {
            ...
            // UPS補償電流
            'upsPower_A': (yesterdayUpsPower_A * 24 + 1 * 220 * 24 / 1000).toFixed(2),
            //'upsPower_A': (yesterdayUpsPower_A * 24 + 1.5 * 220 * 24 / 1000).toFixed(2),
            'upsPower_B': (yesterdayUpsPower_B * 24 + + 1 * 220 * 24 / 1000).toFixed(2),
            //'upsPower_B': (yesterdayUpsPower_B * 24 + 2 * 220 * 24 / 1000).toFixed(2),
            // 水塔馬達
            'waterTank': (yesterdayWaterTankPower * 24).toFixed(2),
