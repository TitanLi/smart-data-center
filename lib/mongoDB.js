...
module.exports = function(io){
  ...
  this.aggregateYesterdayAvgPowerRobot = () => {
    return co(function * (){
      this.yesterday = (new Date().getMonth()+1)+" "+(new Date().getDate()-1)+", "+new Date().getUTCFullYear()+" ";
      this.yesterdayStart = new Date(this.yesterday+"00:00:00");
      this.yesterdayEnd = new Date(this.yesterday+"23:59:59");
