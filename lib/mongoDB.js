class MongoDB {
    ...
    async yesterdayAvgPowerRobot() {
        ...
        let yesterdayPower = {
            ...
            // UPS補償電流
            'upsPower_A': (yesterdayUpsPower_A * 24 + 1.5 * 220 * 1.732 * 24 / 1000).toFixed(1),
            'upsPower_B': (yesterdayUpsPower_B * 24 + 2 * 220 * 1.732 * 24 / 1000).toFixed(1),
            'cameraPowerConsumption': (cameraPowerLog.cameraPowerConsumption).toFixed(1),
